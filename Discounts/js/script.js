...
//multiply the item price with the discount, subtract the discount amount from the original price.  Then determine sales tax amount and add to discounted price
