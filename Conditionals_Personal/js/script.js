...
//This program will prompt the user to enter the par and their score for a 18 hole game of golf.  It will display their score and how much they are +/- par
...
console.log("You finished this game " + plusOrMinus + scoreDifference + ", on a par " + parForCourse + " course, with a score of " + playerScore + ".\n");//Outputs the players current standing compared to par and their current score
